...
struct DemoMainView: View {
    ...
    var body: some View {
        ...
        let visiblePlayerConfig = DTKISVisiblePlayerConfig(playerPosition: playerPosition, widthPercent: visiblePlayerWidth, ratio: ratio, horizontalMargin: 20.0, verticalMargin: 20.0)
