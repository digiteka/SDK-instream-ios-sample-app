...
struct DemoMainView: View {
    ...
    var body: some View {
        ...
        let visiblePlayerConfig = DTKISVisiblePlayerConfig(playerPosition: playerPosition, widthPercent: visiblePlayerWidth, ratio: ratio, horizontalMargin: horizontalMargin, verticalMargin: verticalMargin)
