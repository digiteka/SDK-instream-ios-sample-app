...
class VideoTableViewCell: UITableViewCell {
    ...
    func setUp(playMode: PlayMode) {
        if !isSetup {
            ...
            do {
                try videoView = InStream.shared.initVideoViewWith(zone: zone, src: src, urlreferrer: urlreferrer, gdprconsentstring: gdprconsentstring, tagparam: tagparam, playMode: playMode)
            }
            catch {
            }
