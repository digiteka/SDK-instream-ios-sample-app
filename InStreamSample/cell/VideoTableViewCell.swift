...
class VideoTableViewCell: UITableViewCell {
    ...
    override func awakeFromNib() {
        ...
        videoView = InStream.shared.getInStreamVideoView(mdtk: mdtk, zone: zone, src: src, urlreferrer: urlreferrer, gdprconsentstring: gdprconsentstring, tagparam: tagparam, autoplay: false)
